...
| PVT | code | f MHz | Idd running uA | Idd disabled uA | vbp V | vbn V | start-up ns | stage.py predicts MHz |
|---|---|---|---|---|---|---|---|---|
| tt_27C_1.20V | 255 | 164.26 | 599.4 | 581.7 | 0.461 | 0.572 | 3.5 | 363.4 |
| ss_125C_1.08V | 255 | 89.73 | 297.7 | 288.9 | 0.430 | 0.523 | 6.3 | 200.5 |
| ff_-40C_1.32V | 255 | 274.50 | 1077.3 | 1043.6 | 0.525 | 0.600 | 2.1 | 598.0 |

**All 3 PVT points**, frequency extremes per code, and monotonicity:
| code | slowest MHz | at | fastest MHz | at | fast/slow |
|---|---|---|---|---|---|
| 255 | 89.73 | ss_125C_1.08V | 274.50 | ff_-40C_1.32V | 3.06 |

f(code) monotonic over the codes simulated at 3 of 3 PVT points.

**Stopped** (enable=0, every PVT point and code): clk_out never below 1.080 V at the operating point, 1.080 V during the hold. Disabled supply current is the DAC's (288.9 .. 1044 uA over codes and corners). **Start-up**: worst release-to-first-edge 6 ns at ss_125C_1.08V code 255.
